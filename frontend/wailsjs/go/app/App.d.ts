...
import {commandcenter} from '../models';
...
export function GetCommandCenterBranches(arg1:string):Promise<Array<commandcenter.BranchInfo>>;

export function GetCommandCenterSnapshot():Promise<commandcenter.Snapshot>;
...
export function RefreshCommandCenterRepo(arg1:string):Promise<void>;
...
export function SaveCommandCenterDefinition(arg1:commandcenter.Definition):Promise<void>;
...
export function SetCommandCenterTarget(arg1:string,arg2:commandcenter.Target):Promise<void>;
...
export function StartAllCommandCenter():Promise<void>;

export function StartCommandCenterRepo(arg1:string):Promise<void>;

export function StartCommandCenterService(arg1:string,arg2:string):Promise<void>;
