export namespace app {
	...
	export class ExtensionDTO {
	    name: string;
	    main: string;
	    commands?: extensions.Contribution[];
	    panels?: extensions.Contribution[];
	    dir: string;
	    script: string;
	    enabled: boolean;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.commands = this.convertValues(source["commands"], extensions.Contribution);
	        this.panels = this.convertValues(source["panels"], extensions.Contribution);
	        this.dir = source["dir"];
...
export namespace liveshare {
	...
	export class GuestInfo {
	    ...
	    static createFrom(source: any = {}) {
	        return new GuestInfo(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.id = source["id"];
	        this.canType = source["canType"];
	    }
	}
